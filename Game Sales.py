...
top5_na_reg = (
    game_sales_by_region.sort_values("na_sales", ascending=False)
    .head(5)
...
top5_jp_reg = (
    game_sales_by_region.sort_values("jp_sales", ascending=False)
    .head(5)
...
top5_pal_reg = (
    game_sales_by_region.sort_values("pal_sales", ascending=False)
    .head(5)
...
top5_other_reg = (
    game_sales_by_region.sort_values("other_sales", ascending=False)
    .head(5)
    .drop(columns=["na_sales", "jp_sales", "pal_sales", "total_sales"])
    .rename(columns={"other_sales": "sales"})
)
# %%
top1_per_reg = pd.concat(
    [
        top5_na_reg.head(1),
        top5_jp_reg.head(1),
        top5_pal_reg.head(1),
        top5_other_reg.head(1),
    ]
)
top1_per_reg["Region"] = [
    "North America",
